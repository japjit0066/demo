...
func main() {
	...
	case "flavoured":
		...
		if yesNo == "no" {
			...
			time.Sleep(200 * time.Millisecond)
			fmt.Printf("thanks for buying %v flavoured water bottles ", number)
			time.Sleep(200 * time.Millisecond)
	...
	case "sparkling":
		...
		if yesNo == "no" {
			...
			fmt.Println("we will send an email to ", email)
			time.Sleep(200 * time.Millisecond)
			fmt.Printf("thanks for buying %v sparkling water bottles ", number)
			time.Sleep(200 * time.Millisecond)
			fmt.Println("see you next time ", name)
			fmt.Println("👋 👋 👋 ", "", "system shut down", "👋 👋 👋 ")
		}
	case "natural":
		...
		if yesNo == "no" {
			...
			fmt.Println("we will send an email to ", email)
			time.Sleep(200 * time.Millisecond)
			fmt.Printf("thanks for buying %v natural water bottles ", number)
			time.Sleep(200 * time.Millisecond)
			fmt.Println("see you next time ", name)
	...
	fmt.Println("⚠️ ⚠️ ⚠️", "", "error system shut down", "⚠️ ⚠️ ⚠️")
	fmt.Printf("")
